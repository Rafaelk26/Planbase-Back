...
CREATE SCHEMA IF NOT EXISTS `planbase` DEFAULT CHARACTER SET utf8 ;
USE `planbase` ;

-- -----------------------------------------------------
-- Table `planbasedb`.`contabancaria`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `planbase`.`contabancaria` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `planbase`.`fornecedor` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `planbase`.`registro` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_registro_contaBancaria1`
    ...
    REFERENCES `planbase`.`contabancaria` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE,
  CONSTRAINT `fk_registro_fornecedor`
    FOREIGN KEY (`fornecedor_id`)
    REFERENCES `planbase`.`fornecedor` (`id`)
    ON DELETE CASCADE
    ON UPDATE CASCADE)
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8;
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `planbase`.`usuario` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
INSERT INTO `planbase`.`fornecedor` (`nome`, `tipo`, `contato`, `valorContrato`)
VALUES
...
INSERT INTO `planbase`.`contabancaria` (`agencia`, `conta`, `instituicaoBancaria`, `codigoBancario`, `taxa`, `tipoCobranca`)
VALUES
